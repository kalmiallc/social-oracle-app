<template>
  <div class="flex flex-col">
    <div class="flex w-full items-center justify-center mb-3">
      <NuxtIcon name="icon/mail" class="text-primary text-[40px]"></NuxtIcon>
    </div>

    <div v-if="step === 1">
      <div class="flex items-center justify-center text-[14px] leading-[20px] font-bold">Log in or sign up</div>
      <n-input
        class="mt-6"
        v-model:value="email"
    ...
    <div v-if="step === 2">
      <div class="flex items-center justify-center text-[14px] leading-[20px] font-bold">Enter confirmation code</div>
      <div class="text-center text-[12px] leading-[16px] mt-6">
      ...
      <div class="flex items-center justify-center mt-12 w-full">
        <v-otp-input
          ...
          :is-disabled="loading"
        />
        <div v-else class="h-[40px] relative">
          <Spinner></Spinner>
        </div>
      </div>
...
async function logIn() {
  if (!email.value || !otpCode.value || loading.value) {
    return;
  }
